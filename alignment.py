...
Top = float((((TGrX[0] - UGrX[0]))**2 + ((TGrY[0] - UGrY[0]))**2)**(1/2)) 
Bottom = float((((YGrX[0] - IGrX[0]))**2 + ((YGrY[0] - IGrY[0]))**2)**(1/2))
Left = float((((TGrX[0] - YGrX[0]))**2 + ((TGrY[0] - YGrY[0]))**2)**(1/2))
Right = float((((UGrX[0] - IGrX[0]))**2 + ((UGrY[0] - IGrY[0]))**2)**(1/2))
print "Length: ", "Top:" , Top , " Bot:" , Bottom , " Left:"  ,Left , " Right:", Right
